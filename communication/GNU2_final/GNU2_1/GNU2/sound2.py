...
class sound2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sound2")
        ...
        self.qtgui_sink_x_0_0_0.set_block_alias("Signal")
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\hebam\\Downloads\\Rec.wav', True)
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.qtgui_sink_x_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 10000, 5000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=sound2, options=None):
