...
class transmittorMic(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmittorMic")
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            'C:\\Users\\hebam\\Downloads\\output.wav',
            1,
            250000,
            blocks.FORMAT_WAV,
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_wavfile_sink_0, 0))
...
def main(top_block_cls=transmittorMic, options=None):
