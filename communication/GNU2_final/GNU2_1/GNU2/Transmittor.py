...
class Transmittor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transmittor")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\hebam\\Downloads\\paper-planes-chill-future-beat-283956_1.wav', True)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 320000, 1, 0, 0)
...
def main(top_block_cls=Transmittor, options=None):
