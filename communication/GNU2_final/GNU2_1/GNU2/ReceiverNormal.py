...
class ReceiverNormal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ReceiverNormal")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, 5000, 5000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ReceiverNormal, options=None):
