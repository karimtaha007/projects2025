...
class transmittorNormal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmittorNormal")
...
def main(top_block_cls=transmittorNormal, options=None):
